		    ...
		    for ($i=1; $i < $totalgrave ; $i++) { 
		    	...
		    	if ($numrows > 0) {
		    	    ...
		    	    $now = date("m/d/Y");
		    	     ...
		    	     if ($years >= 5) {
		    	     	# code...
		    	     	$msg = "It is 5 years seen the dead is buried and you must pay the amortization";
		    	     }else{
		    	     	$msg="";
		    	     }
		    	     ...
		    	     $data_details='<p><table> 
									...
									<tr >
										<td ><div>Location:</div></td>
										<td colspan=3 ><div class=stretch><img src='.web_root.'admin/person/'.$result->GRAVEPIC.'></div></td>  
									</tr> 
									<tr > 
		            ...
		            //                         <a href="#" data-toggle="popover" data-placement="bottom" data-content="'.$data_details.'" title="Grave Details" autofocus >'. $result->GRAVENO.'</a>
		            //                       </td>';
							...
							$display_grave = '<td class="graveborder gravebg" style="width:'.$width.'px;height:'.$height.'px;">
									<a href="#" data-toggle="popover" data-placement="bottom" data-content="'.$data_details.'" title="Grave Details" >'.$result->GRAVENO.'</a>
							 	  </td>';
		    		   ...
		    		   $display_grave = '<td class="graveborder gravebg" style="width:'.$width.'px;height:'.$height.'px;">
		                                    <a href="#" data-toggle="popover" data-placement="bottom" data-content="none" title="Grave Details" autofocus >'. $i.'</a>
		                                  </td>';
		    	}
		    ...
		    for ($i=$start; $i < $end ; $i++) { 
		    	...
		    	if ($numrows > 0) {
		            ...
		            //                       </td>';
		    		   ...
		    		   $display_grave = '<td class="graveborder gravebg" style="width:'.$width.'px;height:'.$height.'px;">
		                                    <a href="#" data-toggle="popover" data-placement="bottom" data-content="none" title="Grave Details" >'. $i.'</a>
		                                  </td>';
		    	}
